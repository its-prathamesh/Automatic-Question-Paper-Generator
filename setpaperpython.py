...
def pythonpaper():
    ...
    def next1():
        ...
        preview(acc,bc,aa,aa1,aa2,aa3,aa4,aa5,aa6,aa7,aa8,aa9,aa10,aa11,aa12,aa13,aa14,aa15,aa16,aa17,aa18,aa19,aa20,aa21,aa22,aa23,aa24,aa25,aa26,aa27,aa28,aa29,aa30)
        


    canvas=Canvas(root,height=h,bg="white",width=w,bd=0,relief=RIDGE,scrollregion=(0,0,0,2200),highlightcolor="#016193")
...
#-------------------------------------------------------------------------------------------------------------------------------------
    ...
    c23=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c23,textvariabl=variable22,state='readonly',wrap=True)
    def om23():
        global aa22
        if(str(variable22.get())=='pychap1(R 2)'):
            aa22=random.choice(L1)
            L1.remove(aa22)
        elif(str(variable22.get())=='pychap1(R 4)'):
            aa22=random.choice(L2)
            L2.remove(aa22)
        elif(str(variable22.get())=='pychap1(R 6)'):
            aa22=random.choice(L3)
            L3.remove(aa22)
        elif(str(variable22.get())=='pychap1(U 2)'):
            aa22=random.choice(L4)
            L4.remove(aa22)
        elif(str(variable22.get())=='pychap1(U 4)'):
            aa22=random.choice(L5)
            L5.remove(aa22)
        elif(str(variable22.get())=='pychap1(U 6)'):
            aa22=random.choice(L6)
            L6.remove(aa22)
        elif(str(variable22.get())=='pychap1(A 2)'):
            aa22=random.choice(L7)
            L7.remove(aa22)
        elif(str(variable22.get())=='pychap1(A 4)'):
            aa22=random.choice(L8)
            L8.remove(aa22)
        elif(str(variable22.get())=='pychap1(A 6)'):
            aa22=random.choice(L9)
            L9.remove(aa22)
        elif(str(variable22.get())=='pychap2(R 2)'):
            aa22=random.choice(L10)
            L10.remove(aa22)
        elif(str(variable22.get())=='pychap2(R 4)'):
            aa22=random.choice(L11)
            L11.remove(aa22)
        elif(str(variable22.get())=='pychap2(R 6)'):
            aa22=random.choice(L12)
            L12.remove(aa22)
        elif(str(variable22.get())=='pychap2(U 2)'):
            aa22=random.choice(L13)
            L13.remove(aa22)
        elif(str(variable22.get())=='pychap2(U 4)'):
            aa22=random.choice(L14)
            L14.remove(aa22)
        elif(str(variable22.get())=='pychap2(U 6)'):
            aa22=random.choice(L15)
            L15.remove(aa22)
        elif(str(variable22.get())=='pychap2(A 2)'):
            aa22=random.choice(L16)
            L16.remove(aa22)
        elif(str(variable22.get())=='pychap2(A 4)'):
            aa22=random.choice(L17)
            L17.remove(aa22)
        elif(str(variable22.get())=='pychap2(A 6)'):
            aa22=random.choice(L18)
            L18.remove(aa22)
        elif(str(variable22.get())=='pychap3(R 2)'):
            aa22=random.choice(L19)
            L19.remove(aa22)
        elif(str(variable22.get())=='pychap3(R 4)'):
            aa22=random.choice(L20)
            L20.remove(aa22)
        elif(str(variable22.get())=='pychap3(R 6)'):
            aa22=random.choice(L21)
            L21.remove(aa22)
        elif(str(variable22.get())=='pychap3(U 2)'):
            aa22=random.choice(L22)
            L22.remove(aa22)
        elif(str(variable22.get())=='pychap3(U 4)'):
            aa22=random.choice(L23)
            L23.remove(aa22)
        elif(str(variable22.get())=='pychap3(U 6)'):
            aa22=random.choice(L24)
            L24.remove(aa22)
        elif(str(variable22.get())=='pychap3(A 2)'):
            aa22=random.choice(L25)
            L25.remove(aa22)
        elif(str(variable22.get())=='pychap3(A 4)'):
            aa22=random.choice(L26)
            L26.remove(aa22)
        elif(str(variable22.get())=='pychap3(A 6)'):
            aa22=random.choice(L27)
            L27.remove(aa22)
        elif(str(variable22.get())=='pychap4(R 2)'):
            aa22=random.choice(L28)
            L28.remove(aa22)
        elif(str(variable22.get())=='pychap4(R 4)'):
            aa22=random.choice(L29)
            L29.remove(aa22)
        elif(str(variable22.get())=='pychap4(R 6)'):
            aa22=random.choice(L30)
            L30.remove(aa22)
        elif(str(variable22.get())=='pychap4(U 2)'):
            aa22=random.choice(L31)
            L31.remove(aa22)
        elif(str(variable22.get())=='pychap4(U 4)'):
            aa22=random.choice(L32)
            L32.remove(aa22)
        elif(str(variable22.get())=='pychap4(U 6)'):
            aa22=random.choice(L33)
            L33.remove(aa22)
        elif(str(variable22.get())=='pychap4(A 2)'):
            aa22=random.choice(L34)
            L34.remove(aa22)
        elif(str(variable22.get())=='pychap4(A 4)'):
            aa22=random.choice(L35)
            L35.remove(aa22)
        elif(str(variable22.get())=='pychap4(A 6)'):
            aa22=random.choice(L36)
            L36.remove(aa22)
        elif(str(variable22.get())=='pychap5(R 2)'):
            aa22=random.choice(L37)
            L37.remove(aa22)
        elif(str(variable22.get())=='pychap5(R 4)'):
            aa22=random.choice(L38)
            L38.remove(aa22)
        elif(str(variable22.get())=='pychap5(R 6)'):
            aa22=random.choice(L39)
            L39.remove(aa22)
        elif(str(variable22.get())=='pychap5(U 2)'):
            aa22=random.choice(L40)
            L40.remove(aa22)
        elif(str(variable22.get())=='pychap5(U 4)'):
            aa22=random.choice(L41)
            L41.remove(aa22)
        elif(str(variable22.get())=='pychap5(U 6)'):
            aa22=random.choice(L42)
            L42.remove(aa22)
        elif(str(variable22.get())=='pychap5(A 2)'):
            aa22=random.choice(L43)
            L43.remove(aa22)
        elif(str(variable22.get())=='pychap5(A 4)'):
            aa22=random.choice(L44)
            L44.remove(aa22)
        elif(str(variable22.get())=='pychap5(A 6)'):
...
#-------------------------------------------------------------------------------------------------------------------------------------
    ...
    c24=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c24,textvariabl=variable23,state='readonly',wrap=True)
    def om24():
        global aa23
        if(str(variable23.get())=='pychap1(R 2)'):
            aa23=random.choice(L1)
            L1.remove(aa23)
        elif(str(variable23.get())=='pychap1(R 4)'):
            aa23=random.choice(L2)
            L2.remove(aa23)
        elif(str(variable23.get())=='pychap1(R 6)'):
            aa23=random.choice(L3)
            L3.remove(aa23)
        elif(str(variable23.get())=='pychap1(U 2)'):
            aa23=random.choice(L4)
            L4.remove(aa23)
        elif(str(variable23.get())=='pychap1(U 4)'):
            aa23=random.choice(L5)
            L5.remove(aa23)
        elif(str(variable23.get())=='pychap1(U 6)'):
            aa23=random.choice(L6)
            L6.remove(aa23)
        elif(str(variable23.get())=='pychap1(A 2)'):
            aa23=random.choice(L7)
            L7.remove(aa23)
        elif(str(variable23.get())=='pychap1(A 4)'):
            aa23=random.choice(L8)
            L8.remove(aa23)
        elif(str(variable23.get())=='pychap1(A 6)'):
            aa23=random.choice(L9)
            L9.remove(aa23)
        elif(str(variable23.get())=='pychap2(R 2)'):
            aa23=random.choice(L10)
            L10.remove(aa23)
        elif(str(variable23.get())=='pychap2(R 4)'):
            aa23=random.choice(L11)
            L11.remove(aa23)
        elif(str(variable23.get())=='pychap2(R 6)'):
            aa23=random.choice(L12)
            L12.remove(aa23)
        elif(str(variable23.get())=='pychap2(U 2)'):
            aa23=random.choice(L13)
            L13.remove(aa23)
        elif(str(variable23.get())=='pychap2(U 4)'):
            aa23=random.choice(L14)
            L14.remove(aa23)
        elif(str(variable23.get())=='pychap2(U 6)'):
            aa23=random.choice(L15)
            L15.remove(aa23)
        elif(str(variable23.get())=='pychap2(A 2)'):
            aa23=random.choice(L16)
            L16.remove(aa23)
        elif(str(variable23.get())=='pychap2(A 4)'):
            aa23=random.choice(L17)
            L17.remove(aa23)
        elif(str(variable23.get())=='pychap2(A 6)'):
            aa23=random.choice(L18)
            L18.remove(aa23)
        elif(str(variable23.get())=='pychap3(R 2)'):
            aa23=random.choice(L19)
            L19.remove(aa23)
        elif(str(variable23.get())=='pychap3(R 4)'):
            aa23=random.choice(L20)
            L20.remove(aa23)
        elif(str(variable23.get())=='pychap3(R 6)'):
            aa23=random.choice(L21)
            L21.remove(aa23)
        elif(str(variable23.get())=='pychap3(U 2)'):
            aa23=random.choice(L22)
            L22.remove(aa23)
        elif(str(variable23.get())=='pychap3(U 4)'):
            aa23=random.choice(L23)
            L23.remove(aa23)
        elif(str(variable23.get())=='pychap3(U 6)'):
            aa23=random.choice(L24)
            L24.remove(aa23)
        elif(str(variable23.get())=='pychap3(A 2)'):
            aa23=random.choice(L25)
            L25.remove(aa23)
        elif(str(variable23.get())=='pychap3(A 4)'):
            aa23=random.choice(L26)
            L26.remove(aa23)
        elif(str(variable23.get())=='pychap3(A 6)'):
            aa23=random.choice(L27)
            L27.remove(aa23)
        elif(str(variable23.get())=='pychap4(R 2)'):
            aa23=random.choice(L28)
            L28.remove(aa23)
        elif(str(variable23.get())=='pychap4(R 4)'):
            aa23=random.choice(L29)
            L29.remove(aa23)
        elif(str(variable23.get())=='pychap4(R 6)'):
            aa23=random.choice(L30)
            L30.remove(aa23)
        elif(str(variable23.get())=='pychap4(U 2)'):
            aa23=random.choice(L31)
            L31.remove(aa23)
        elif(str(variable23.get())=='pychap4(U 4)'):
            aa23=random.choice(L32)
            L32.remove(aa23)
        elif(str(variable23.get())=='pychap4(U 6)'):
            aa23=random.choice(L33)
            L33.remove(aa23)
        elif(str(variable23.get())=='pychap4(A 2)'):
            aa23=random.choice(L34)
            L34.remove(aa23)
        elif(str(variable23.get())=='pychap4(A 4)'):
            aa23=random.choice(L35)
            L35.remove(aa23)
        elif(str(variable23.get())=='pychap4(A 6)'):
            aa23=random.choice(L36)
            L36.remove(aa23)
        elif(str(variable23.get())=='pychap5(R 2)'):
            aa23=random.choice(L37)
            L37.remove(aa23)
        elif(str(variable23.get())=='pychap5(R 4)'):
            aa23=random.choice(L38)
            L38.remove(aa23)
        elif(str(variable23.get())=='pychap5(R 6)'):
            aa23=random.choice(L39)
            L39.remove(aa23)
        elif(str(variable23.get())=='pychap5(U 2)'):
            aa23=random.choice(L40)
            L40.remove(aa23)
        elif(str(variable23.get())=='pychap5(U 4)'):
            aa23=random.choice(L41)
            L41.remove(aa23)
        elif(str(variable23.get())=='pychap5(U 6)'):
            aa23=random.choice(L42)
            L42.remove(aa23)
        elif(str(variable23.get())=='pychap5(A 2)'):
            aa23=random.choice(L43)
            L43.remove(aa23)
        elif(str(variable23.get())=='pychap5(A 4)'):
            aa23=random.choice(L44)
            L44.remove(aa23)
        elif(str(variable23.get())=='pychap5(A 6)'):
    ...
    c25=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c25,textvariabl=variable24,state='readonly',wrap=True)
    def om25():
        global aa24
        if(str(variable24.get())=='pychap1(R 2)'):
            aa24=random.choice(L1)
            L1.remove(aa24)
        elif(str(variable24.get())=='pychap1(R 4)'):
            aa24=random.choice(L2)
            L2.remove(aa24)
        elif(str(variable24.get())=='pychap1(R 6)'):
            aa24=random.choice(L3)
            L3.remove(aa24)
        elif(str(variable24.get())=='pychap1(U 2)'):
            aa24=random.choice(L4)
            L4.remove(aa24)
        elif(str(variable24.get())=='pychap1(U 4)'):
            aa24=random.choice(L5)
            L5.remove(aa24)
        elif(str(variable24.get())=='pychap1(U 6)'):
            aa24=random.choice(L6)
            L6.remove(aa24)
        elif(str(variable24.get())=='pychap1(A 2)'):
            aa24=random.choice(L7)
            L7.remove(aa24)
        elif(str(variable24.get())=='pychap1(A 4)'):
            aa24=random.choice(L8)
            L8.remove(aa24)
        elif(str(variable24.get())=='pychap1(A 6)'):
            aa24=random.choice(L9)
            L9.remove(aa24)
        elif(str(variable24.get())=='pychap2(R 2)'):
            aa24=random.choice(L10)
            L10.remove(aa24)
        elif(str(variable24.get())=='pychap2(R 4)'):
            aa24=random.choice(L11)
            L11.remove(aa24)
        elif(str(variable24.get())=='pychap2(R 6)'):
            aa24=random.choice(L12)
            L12.remove(aa24)
        elif(str(variable24.get())=='pychap2(U 2)'):
            aa24=random.choice(L13)
            L13.remove(aa24)
        elif(str(variable24.get())=='pychap2(U 4)'):
            aa24=random.choice(L14)
            L14.remove(aa24)
        elif(str(variable24.get())=='pychap2(U 6)'):
            aa24=random.choice(L15)
            L15.remove(aa24)
        elif(str(variable24.get())=='pychap2(A 2)'):
            aa24=random.choice(L16)
            L16.remove(aa24)
        elif(str(variable24.get())=='pychap2(A 4)'):
            aa24=random.choice(L17)
            L17.remove(aa24)
        elif(str(variable24.get())=='pychap2(A 6)'):
            aa24=random.choice(L18)
            L18.remove(aa24)
        elif(str(variable24.get())=='pychap3(R 2)'):
            aa24=random.choice(L19)
            L19.remove(aa24)
        elif(str(variable24.get())=='pychap3(R 4)'):
            aa24=random.choice(L20)
            L20.remove(aa24)
        elif(str(variable24.get())=='pychap3(R 6)'):
            aa24=random.choice(L21)
            L21.remove(aa24)
        elif(str(variable24.get())=='pychap3(U 2)'):
            aa24=random.choice(L22)
            L22.remove(aa24)
        elif(str(variable24.get())=='pychap3(U 4)'):
            aa24=random.choice(L23)
            L23.remove(aa24)
        elif(str(variable24.get())=='pychap3(U 6)'):
            aa24=random.choice(L24)
            L24.remove(aa24)
        elif(str(variable24.get())=='pychap3(A 2)'):
            aa24=random.choice(L25)
            L25.remove(aa24)
        elif(str(variable24.get())=='pychap3(A 4)'):
            aa24=random.choice(L26)
            L26.remove(aa24)
        elif(str(variable24.get())=='pychap3(A 6)'):
            aa24=random.choice(L27)
            L27.remove(aa24)
        elif(str(variable24.get())=='pychap4(R 2)'):
            aa24=random.choice(L28)
            L28.remove(aa24)
        elif(str(variable24.get())=='pychap4(R 4)'):
            aa24=random.choice(L29)
            L29.remove(aa24)
        elif(str(variable24.get())=='pychap4(R 6)'):
            aa24=random.choice(L30)
            L30.remove(aa24)
        elif(str(variable24.get())=='pychap4(U 2)'):
            aa24=random.choice(L31)
            L31.remove(aa24)
        elif(str(variable24.get())=='pychap4(U 4)'):
            aa24=random.choice(L32)
            L32.remove(aa24)
        elif(str(variable24.get())=='pychap4(U 6)'):
            aa24=random.choice(L33)
            L33.remove(aa24)
        elif(str(variable24.get())=='pychap4(A 2)'):
            aa24=random.choice(L34)
            L34.remove(aa24)
        elif(str(variable24.get())=='pychap4(A 4)'):
            aa24=random.choice(L35)
            L35.remove(aa24)
        elif(str(variable24.get())=='pychap4(A 6)'):
            aa24=random.choice(L36)
            L36.remove(aa24)
        elif(str(variable24.get())=='pychap5(R 2)'):
            aa24=random.choice(L37)
            L37.remove(aa24)
        elif(str(variable24.get())=='pychap5(R 4)'):
            aa24=random.choice(L38)
            L38.remove(aa24)
        elif(str(variable24.get())=='pychap5(R 6)'):
            aa24=random.choice(L39)
            L39.remove(aa24)
        elif(str(variable24.get())=='pychap5(U 2)'):
            aa24=random.choice(L40)
            L40.remove(aa24)
        elif(str(variable24.get())=='pychap5(U 4)'):
            aa24=random.choice(L41)
            L41.remove(aa24)
        elif(str(variable24.get())=='pychap5(U 6)'):
            aa24=random.choice(L42)
            L42.remove(aa24)
        elif(str(variable24.get())=='pychap5(A 2)'):
            aa24=random.choice(L43)
            L43.remove(aa24)
        elif(str(variable24.get())=='pychap5(A 4)'):
            aa24=random.choice(L44)
            L44.remove(aa24)
        elif(str(variable24.get())=='pychap5(A 6)'):
    ...
    c26=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c26,textvariabl=variable25,state='readonly',wrap=True)
    def om26():
        global aa25
        if(str(variable25.get())=='pychap1(R 2)'):
            aa25=random.choice(L1)
            L1.remove(aa25)
        elif(str(variable25.get())=='pychap1(R 4)'):
            aa25=random.choice(L2)
            L2.remove(aa25)
        elif(str(variable25.get())=='pychap1(R 6)'):
            aa25=random.choice(L3)
            L3.remove(aa25)
        elif(str(variable25.get())=='pychap1(U 2)'):
            aa25=random.choice(L4)
            L4.remove(aa25)
        elif(str(variable25.get())=='pychap1(U 4)'):
            aa25=random.choice(L5)
            L5.remove(aa25)
        elif(str(variable25.get())=='pychap1(U 6)'):
            aa25=random.choice(L6)
            L6.remove(aa25)
        elif(str(variable25.get())=='pychap1(A 2)'):
            aa25=random.choice(L7)
            L7.remove(aa25)
        elif(str(variable25.get())=='pychap1(A 4)'):
            aa25=random.choice(L8)
            L8.remove(aa25)
        elif(str(variable25.get())=='pychap1(A 6)'):
            aa25=random.choice(L9)
            L9.remove(aa25)
        elif(str(variable25.get())=='pychap2(R 2)'):
            aa25=random.choice(L10)
            L10.remove(aa25)
        elif(str(variable25.get())=='pychap2(R 4)'):
            aa25=random.choice(L11)
            L11.remove(aa25)
        elif(str(variable25.get())=='pychap2(R 6)'):
            aa25=random.choice(L12)
            L12.remove(aa25)
        elif(str(variable25.get())=='pychap2(U 2)'):
            aa25=random.choice(L13)
            L13.remove(aa25)
        elif(str(variable25.get())=='pychap2(U 4)'):
            aa25=random.choice(L14)
            L14.remove(aa25)
        elif(str(variable25.get())=='pychap2(U 6)'):
            aa25=random.choice(L15)
            L15.remove(aa25)
        elif(str(variable25.get())=='pychap2(A 2)'):
            aa25=random.choice(L16)
            L16.remove(aa25)
        elif(str(variable25.get())=='pychap2(A 4)'):
            aa25=random.choice(L17)
            L17.remove(aa25)
        elif(str(variable25.get())=='pychap2(A 6)'):
            aa25=random.choice(L18)
            L18.remove(aa25)
        elif(str(variable25.get())=='pychap3(R 2)'):
            aa25=random.choice(L19)
            L19.remove(aa25)
        elif(str(variable25.get())=='pychap3(R 4)'):
            aa25=random.choice(L20)
            L20.remove(aa25)
        elif(str(variable25.get())=='pychap3(R 6)'):
            aa25=random.choice(L21)
            L21.remove(aa25)
        elif(str(variable25.get())=='pychap3(U 2)'):
            aa25=random.choice(L22)
            L22.remove(aa25)
        elif(str(variable25.get())=='pychap3(U 4)'):
            aa25=random.choice(L23)
            L23.remove(aa25)
        elif(str(variable25.get())=='pychap3(U 6)'):
            aa25=random.choice(L24)
            L24.remove(aa25)
        elif(str(variable25.get())=='pychap3(A 2)'):
            aa25=random.choice(L25)
            L25.remove(aa25)
        elif(str(variable25.get())=='pychap3(A 4)'):
            aa25=random.choice(L26)
            L26.remove(aa25)
        elif(str(variable25.get())=='pychap3(A 6)'):
            aa25=random.choice(L27)
            L27.remove(aa25)
        elif(str(variable25.get())=='pychap4(R 2)'):
            aa25=random.choice(L28)
            L28.remove(aa25)
        elif(str(variable25.get())=='pychap4(R 4)'):
            aa25=random.choice(L29)
            L29.remove(aa25)
        elif(str(variable25.get())=='pychap4(R 6)'):
            aa25=random.choice(L30)
            L30.remove(aa25)
        elif(str(variable25.get())=='pychap4(U 2)'):
            aa25=random.choice(L31)
            L31.remove(aa25)
        elif(str(variable25.get())=='pychap4(U 4)'):
            aa25=random.choice(L32)
            L32.remove(aa25)
        elif(str(variable25.get())=='pychap4(U 6)'):
            aa25=random.choice(L33)
            L33.remove(aa25)
        elif(str(variable25.get())=='pychap4(A 2)'):
            aa25=random.choice(L34)
            L34.remove(aa25)
        elif(str(variable25.get())=='pychap4(A 4)'):
            aa25=random.choice(L35)
            L35.remove(aa25)
        elif(str(variable25.get())=='pychap4(A 6)'):
            aa25=random.choice(L36)
            L36.remove(aa25)
        elif(str(variable25.get())=='pychap5(R 2)'):
            aa25=random.choice(L37)
            L37.remove(aa25)
        elif(str(variable25.get())=='pychap5(R 4)'):
            aa25=random.choice(L38)
            L38.remove(aa25)
        elif(str(variable25.get())=='pychap5(R 6)'):
            aa25=random.choice(L39)
            L39.remove(aa25)
        elif(str(variable25.get())=='pychap5(U 2)'):
            aa25=random.choice(L40)
            L40.remove(aa25)
        elif(str(variable25.get())=='pychap5(U 4)'):
            aa25=random.choice(L41)
            L41.remove(aa25)
        elif(str(variable25.get())=='pychap5(U 6)'):
            aa25=random.choice(L42)
            L42.remove(aa25)
        elif(str(variable25.get())=='pychap5(A 2)'):
            aa25=random.choice(L43)
            L43.remove(aa25)
        elif(str(variable25.get())=='pychap5(A 4)'):
            aa25=random.choice(L44)
            L44.remove(aa25)
        elif(str(variable25.get())=='pychap5(A 6)'):
    ...
    c27=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c27,textvariabl=variable26,state='readonly',wrap=True)
    def om27():
        global aa26
        if(str(variable26.get())=='pychap1(R 2)'):
            aa26=random.choice(L1)
            L1.remove(aa26)
        elif(str(variable26.get())=='pychap1(R 4)'):
            aa26=random.choice(L2)
            L2.remove(aa26)
        elif(str(variable26.get())=='pychap1(R 6)'):
            aa26=random.choice(L3)
            L3.remove(aa26)
        elif(str(variable26.get())=='pychap1(U 2)'):
            aa26=random.choice(L4)
            L4.remove(aa26)
        elif(str(variable26.get())=='pychap1(U 4)'):
            aa26=random.choice(L5)
            L5.remove(aa26)
        elif(str(variable26.get())=='pychap1(U 6)'):
            aa26=random.choice(L6)
            L6.remove(aa26)
        elif(str(variable26.get())=='pychap1(A 2)'):
            aa26=random.choice(L7)
            L7.remove(aa26)
        elif(str(variable26.get())=='pychap1(A 4)'):
            aa26=random.choice(L8)
            L8.remove(aa26)
        elif(str(variable26.get())=='pychap1(A 6)'):
            aa26=random.choice(L9)
            L9.remove(aa26)
        elif(str(variable26.get())=='pychap2(R 2)'):
            aa26=random.choice(L10)
            L10.remove(aa26)
        elif(str(variable26.get())=='pychap2(R 4)'):
            aa26=random.choice(L11)
            L11.remove(aa26)
        elif(str(variable26.get())=='pychap2(R 6)'):
            aa26=random.choice(L12)
            L12.remove(aa26)
        elif(str(variable26.get())=='pychap2(U 2)'):
            aa26=random.choice(L13)
            L13.remove(aa26)
        elif(str(variable26.get())=='pychap2(U 4)'):
            aa26=random.choice(L14)
            L14.remove(aa26)
        elif(str(variable26.get())=='pychap2(U 6)'):
            aa26=random.choice(L15)
            L15.remove(aa26)
        elif(str(variable26.get())=='pychap2(A 2)'):
            aa26=random.choice(L16)
            L16.remove(aa26)
        elif(str(variable26.get())=='pychap2(A 4)'):
            aa26=random.choice(L17)
            L17.remove(aa26)
        elif(str(variable26.get())=='pychap2(A 6)'):
            aa26=random.choice(L18)
            L18.remove(aa26)
        elif(str(variable26.get())=='pychap3(R 2)'):
            aa26=random.choice(L19)
            L19.remove(aa26)
        elif(str(variable26.get())=='pychap3(R 4)'):
            aa26=random.choice(L20)
            L20.remove(aa26)
        elif(str(variable26.get())=='pychap3(R 6)'):
            aa26=random.choice(L21)
            L21.remove(aa26)
        elif(str(variable26.get())=='pychap3(U 2)'):
            aa26=random.choice(L22)
            L22.remove(aa26)
        elif(str(variable26.get())=='pychap3(U 4)'):
            aa26=random.choice(L23)
            L23.remove(aa26)
        elif(str(variable26.get())=='pychap3(U 6)'):
            aa26=random.choice(L24)
            L24.remove(aa26)
        elif(str(variable26.get())=='pychap3(A 2)'):
            aa26=random.choice(L25)
            L25.remove(aa26)
        elif(str(variable26.get())=='pychap3(A 4)'):
            aa26=random.choice(L26)
            L26.remove(aa26)
        elif(str(variable26.get())=='pychap3(A 6)'):
            aa26=random.choice(L27)
            L27.remove(aa26)
        elif(str(variable26.get())=='pychap4(R 2)'):
            aa26=random.choice(L28)
            L28.remove(aa26)
        elif(str(variable26.get())=='pychap4(R 4)'):
            aa26=random.choice(L29)
            L29.remove(aa26)
        elif(str(variable26.get())=='pychap4(R 6)'):
            aa26=random.choice(L30)
            L30.remove(aa26)
        elif(str(variable26.get())=='pychap4(U 2)'):
            aa26=random.choice(L31)
            L31.remove(aa26)
        elif(str(variable26.get())=='pychap4(U 4)'):
            aa26=random.choice(L32)
            L32.remove(aa26)
        elif(str(variable26.get())=='pychap4(U 6)'):
            aa26=random.choice(L33)
            L33.remove(aa26)
        elif(str(variable26.get())=='pychap4(A 2)'):
            aa26=random.choice(L34)
            L34.remove(aa26)
        elif(str(variable26.get())=='pychap4(A 4)'):
            aa26=random.choice(L35)
            L35.remove(aa26)
        elif(str(variable26.get())=='pychap4(A 6)'):
            aa26=random.choice(L36)
            L36.remove(aa26)
        elif(str(variable26.get())=='pychap5(R 2)'):
            aa26=random.choice(L37)
            L37.remove(aa26)
        elif(str(variable26.get())=='pychap5(R 4)'):
            aa26=random.choice(L38)
            L38.remove(aa26)
        elif(str(variable26.get())=='pychap5(R 6)'):
            aa26=random.choice(L39)
            L39.remove(aa26)
        elif(str(variable26.get())=='pychap5(U 2)'):
            aa26=random.choice(L40)
            L40.remove(aa26)
        elif(str(variable26.get())=='pychap5(U 4)'):
            aa26=random.choice(L41)
            L41.remove(aa26)
        elif(str(variable26.get())=='pychap5(U 6)'):
            aa26=random.choice(L42)
            L42.remove(aa26)
        elif(str(variable26.get())=='pychap5(A 2)'):
            aa26=random.choice(L43)
            L43.remove(aa26)
        elif(str(variable26.get())=='pychap5(A 4)'):
            aa26=random.choice(L44)
            L44.remove(aa26)
        elif(str(variable26.get())=='pychap5(A 6)'):
    ...
    c28=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c28,textvariabl=variable27,state='readonly',wrap=True)
    def om28():
        global aa27
        if(str(variable27.get())=='pychap1(R 2)'):
            aa27=random.choice(L1)
            L1.remove(aa27)
        elif(str(variable27.get())=='pychap1(R 4)'):
            aa27=random.choice(L2)
            L2.remove(aa27)
        elif(str(variable27.get())=='pychap1(R 6)'):
            aa27=random.choice(L3)
            L3.remove(aa27)
        elif(str(variable27.get())=='pychap1(U 2)'):
            aa27=random.choice(L4)
            L4.remove(aa27)
        elif(str(variable27.get())=='pychap1(U 4)'):
            aa27=random.choice(L5)
            L5.remove(aa27)
        elif(str(variable27.get())=='pychap1(U 6)'):
            aa27=random.choice(L6)
            L6.remove(aa27)
        elif(str(variable27.get())=='pychap1(A 2)'):
            aa27=random.choice(L7)
            L7.remove(aa27)
        elif(str(variable27.get())=='pychap1(A 4)'):
            aa27=random.choice(L8)
            L8.remove(aa27)
        elif(str(variable27.get())=='pychap1(A 6)'):
            aa27=random.choice(L9)
            L9.remove(aa27)
        elif(str(variable27.get())=='pychap2(R 2)'):
            aa27=random.choice(L10)
            L10.remove(aa27)
        elif(str(variable27.get())=='pychap2(R 4)'):
            aa27=random.choice(L11)
            L11.remove(aa27)
        elif(str(variable27.get())=='pychap2(R 6)'):
            aa27=random.choice(L12)
            L12.remove(aa27)
        elif(str(variable27.get())=='pychap2(U 2)'):
            aa27=random.choice(L13)
            L13.remove(aa27)
        elif(str(variable27.get())=='pychap2(U 4)'):
            aa27=random.choice(L14)
            L14.remove(aa27)
        elif(str(variable27.get())=='pychap2(U 6)'):
            aa27=random.choice(L15)
            L15.remove(aa27)
        elif(str(variable27.get())=='pychap2(A 2)'):
            aa27=random.choice(L16)
            L16.remove(aa27)
        elif(str(variable27.get())=='pychap2(A 4)'):
            aa27=random.choice(L17)
            L17.remove(aa27)
        elif(str(variable27.get())=='pychap2(A 6)'):
            aa27=random.choice(L18)
            L18.remove(aa27)
        elif(str(variable27.get())=='pychap3(R 2)'):
            aa27=random.choice(L19)
            L19.remove(aa27)
        elif(str(variable27.get())=='pychap3(R 4)'):
            aa27=random.choice(L20)
            L20.remove(aa27)
        elif(str(variable27.get())=='pychap3(R 6)'):
            aa27=random.choice(L21)
            L21.remove(aa27)
        elif(str(variable27.get())=='pychap3(U 2)'):
            aa27=random.choice(L22)
            L22.remove(aa27)
        elif(str(variable27.get())=='pychap3(U 4)'):
            aa27=random.choice(L23)
            L23.remove(aa27)
        elif(str(variable27.get())=='pychap3(U 6)'):
            aa27=random.choice(L24)
            L24.remove(aa27)
        elif(str(variable27.get())=='pychap3(A 2)'):
            aa27=random.choice(L25)
            L25.remove(aa27)
        elif(str(variable27.get())=='pychap3(A 4)'):
            aa27=random.choice(L26)
            L26.remove(aa27)
        elif(str(variable27.get())=='pychap3(A 6)'):
            aa27=random.choice(L27)
            L27.remove(aa27)
        elif(str(variable27.get())=='pychap4(R 2)'):
            aa27=random.choice(L28)
            L28.remove(aa27)
        elif(str(variable27.get())=='pychap4(R 4)'):
            aa27=random.choice(L29)
            L29.remove(aa27)
        elif(str(variable27.get())=='pychap4(R 6)'):
            aa27=random.choice(L30)
            L30.remove(aa27)
        elif(str(variable27.get())=='pychap4(U 2)'):
            aa27=random.choice(L31)
            L31.remove(aa27)
        elif(str(variable27.get())=='pychap4(U 4)'):
            aa27=random.choice(L32)
            L32.remove(aa27)
        elif(str(variable27.get())=='pychap4(U 6)'):
            aa27=random.choice(L33)
            L33.remove(aa27)
        elif(str(variable27.get())=='pychap4(A 2)'):
            aa27=random.choice(L34)
            L34.remove(aa27)
        elif(str(variable27.get())=='pychap4(A 4)'):
            aa27=random.choice(L35)
            L35.remove(aa27)
        elif(str(variable27.get())=='pychap4(A 6)'):
            aa27=random.choice(L36)
            L36.remove(aa27)
        elif(str(variable27.get())=='pychap5(R 2)'):
            aa27=random.choice(L37)
            L37.remove(aa27)
        elif(str(variable27.get())=='pychap5(R 4)'):
            aa27=random.choice(L38)
            L38.remove(aa27)
        elif(str(variable27.get())=='pychap5(R 6)'):
            aa27=random.choice(L39)
            L39.remove(aa27)
        elif(str(variable27.get())=='pychap5(U 2)'):
            aa27=random.choice(L40)
            L40.remove(aa27)
        elif(str(variable27.get())=='pychap5(U 4)'):
            aa27=random.choice(L41)
            L41.remove(aa27)
        elif(str(variable27.get())=='pychap5(U 6)'):
            aa27=random.choice(L42)
            L42.remove(aa27)
        elif(str(variable27.get())=='pychap5(A 2)'):
            aa27=random.choice(L43)
            L43.remove(aa27)
        elif(str(variable27.get())=='pychap5(A 4)'):
            aa27=random.choice(L44)
            L44.remove(aa27)
        elif(str(variable27.get())=='pychap5(A 6)'):
...
#-------------------------------------------------------------------------------------------------------------------------------------
    ...
    c29=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c29,textvariabl=variable28,state='readonly',wrap=True)
    def om29():
        global aa28
        if(str(variable28.get())=='pychap1(R 2)'):
            aa28=random.choice(L1)
            L1.remove(aa28)
        elif(str(variable28.get())=='pychap1(R 4)'):
            aa28=random.choice(L2)
            L2.remove(aa28)
        elif(str(variable28.get())=='pychap1(R 6)'):
            aa28=random.choice(L3)
            L3.remove(aa28)
        elif(str(variable28.get())=='pychap1(U 2)'):
            aa28=random.choice(L4)
            L4.remove(aa28)
        elif(str(variable28.get())=='pychap1(U 4)'):
            aa28=random.choice(L5)
            L5.remove(aa28)
        elif(str(variable28.get())=='pychap1(U 6)'):
            aa28=random.choice(L6)
            L6.remove(aa28)
        elif(str(variable28.get())=='pychap1(A 2)'):
            aa28=random.choice(L7)
            L7.remove(aa28)
        elif(str(variable28.get())=='pychap1(A 4)'):
            aa28=random.choice(L8)
            L8.remove(aa28)
        elif(str(variable28.get())=='pychap1(A 6)'):
            aa28=random.choice(L9)
            L9.remove(aa28)
        elif(str(variable28.get())=='pychap2(R 2)'):
            aa28=random.choice(L10)
            L10.remove(aa28)
        elif(str(variable28.get())=='pychap2(R 4)'):
            aa28=random.choice(L11)
            L11.remove(aa28)
        elif(str(variable28.get())=='pychap2(R 6)'):
            aa28=random.choice(L12)
            L12.remove(aa28)
        elif(str(variable28.get())=='pychap2(U 2)'):
            aa28=random.choice(L13)
            L13.remove(aa28)
        elif(str(variable28.get())=='pychap2(U 4)'):
            aa28=random.choice(L14)
            L14.remove(aa28)
        elif(str(variable28.get())=='pychap2(U 6)'):
            aa28=random.choice(L15)
            L15.remove(aa28)
        elif(str(variable28.get())=='pychap2(A 2)'):
            aa28=random.choice(L16)
            L16.remove(aa28)
        elif(str(variable28.get())=='pychap2(A 4)'):
            aa28=random.choice(L17)
            L17.remove(aa28)
        elif(str(variable28.get())=='pychap2(A 6)'):
            aa28=random.choice(L18)
            L18.remove(aa28)
        elif(str(variable28.get())=='pychap3(R 2)'):
            aa28=random.choice(L19)
            L19.remove(aa28)
        elif(str(variable28.get())=='pychap3(R 4)'):
            aa28=random.choice(L20)
            L20.remove(aa28)
        elif(str(variable28.get())=='pychap3(R 6)'):
            aa28=random.choice(L21)
            L21.remove(aa28)
        elif(str(variable28.get())=='pychap3(U 2)'):
            aa28=random.choice(L22)
            L22.remove(aa28)
        elif(str(variable28.get())=='pychap3(U 4)'):
            aa28=random.choice(L23)
            L23.remove(aa28)
        elif(str(variable28.get())=='pychap3(U 6)'):
            aa28=random.choice(L24)
            L24.remove(aa28)
        elif(str(variable28.get())=='pychap3(A 2)'):
            aa28=random.choice(L25)
            L25.remove(aa28)
        elif(str(variable28.get())=='pychap3(A 4)'):
            aa28=random.choice(L26)
            L26.remove(aa28)
        elif(str(variable28.get())=='pychap3(A 6)'):
            aa28=random.choice(L27)
            L27.remove(aa28)
        elif(str(variable28.get())=='pychap4(R 2)'):
            aa28=random.choice(L28)
            L28.remove(aa28)
        elif(str(variable28.get())=='pychap4(R 4)'):
            aa28=random.choice(L29)
            L29.remove(aa28)
        elif(str(variable28.get())=='pychap4(R 6)'):
            aa28=random.choice(L30)
            L30.remove(aa28)
        elif(str(variable28.get())=='pychap4(U 2)'):
            aa28=random.choice(L31)
            L31.remove(aa28)
        elif(str(variable28.get())=='pychap4(U 4)'):
            aa28=random.choice(L32)
            L32.remove(aa28)
        elif(str(variable28.get())=='pychap4(U 6)'):
            aa28=random.choice(L33)
            L33.remove(aa28)
        elif(str(variable28.get())=='pychap4(A 2)'):
            aa28=random.choice(L34)
            L34.remove(aa28)
        elif(str(variable28.get())=='pychap4(A 4)'):
            aa28=random.choice(L35)
            L35.remove(aa28)
        elif(str(variable28.get())=='pychap4(A 6)'):
            aa28=random.choice(L36)
            L36.remove(aa28)
        elif(str(variable28.get())=='pychap5(R 2)'):
            aa28=random.choice(L37)
            L37.remove(aa28)
        elif(str(variable28.get())=='pychap5(R 4)'):
            aa28=random.choice(L38)
            L38.remove(aa28)
        elif(str(variable28.get())=='pychap5(R 6)'):
            aa28=random.choice(L39)
            L39.remove(aa28)
        elif(str(variable28.get())=='pychap5(U 2)'):
            aa28=random.choice(L40)
            L40.remove(aa28)
        elif(str(variable28.get())=='pychap5(U 4)'):
            aa28=random.choice(L41)
            L41.remove(aa28)
        elif(str(variable28.get())=='pychap5(U 6)'):
            aa28=random.choice(L42)
            L42.remove(aa28)
        elif(str(variable28.get())=='pychap5(A 2)'):
            aa28=random.choice(L43)
            L43.remove(aa28)
        elif(str(variable28.get())=='pychap5(A 4)'):
            aa28=random.choice(L44)
            L44.remove(aa28)
        elif(str(variable28.get())=='pychap5(A 6)'):
    ...
    c30=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c30,textvariabl=variable29,state='readonly',wrap=True)
    def om30():
        global aa29
        if(str(variable29.get())=='pychap1(R 2)'):
            aa29=random.choice(L1)
            L1.remove(aa29)
        elif(str(variable29.get())=='pychap1(R 4)'):
            aa29=random.choice(L2)
            L2.remove(aa29)
        elif(str(variable29.get())=='pychap1(R 6)'):
            aa29=random.choice(L3)
            L3.remove(aa29)
        elif(str(variable29.get())=='pychap1(U 2)'):
            aa29=random.choice(L4)
            L4.remove(aa29)
        elif(str(variable29.get())=='pychap1(U 4)'):
            aa29=random.choice(L5)
            L5.remove(aa29)
        elif(str(variable29.get())=='pychap1(U 6)'):
            aa29=random.choice(L6)
            L6.remove(aa29)
        elif(str(variable29.get())=='pychap1(A 2)'):
            aa29=random.choice(L7)
            L7.remove(aa29)
        elif(str(variable29.get())=='pychap1(A 4)'):
            aa29=random.choice(L8)
            L8.remove(aa29)
        elif(str(variable29.get())=='pychap1(A 6)'):
            aa29=random.choice(L9)
            L9.remove(aa29)
        elif(str(variable29.get())=='pychap2(R 2)'):
            aa29=random.choice(L10)
            L10.remove(aa29)
        elif(str(variable29.get())=='pychap2(R 4)'):
            aa29=random.choice(L11)
            L11.remove(aa29)
        elif(str(variable29.get())=='pychap2(R 6)'):
            aa29=random.choice(L12)
            L12.remove(aa29)
        elif(str(variable29.get())=='pychap2(U 2)'):
            aa29=random.choice(L13)
            L13.remove(aa29)
        elif(str(variable29.get())=='pychap2(U 4)'):
            aa29=random.choice(L14)
            L14.remove(aa29)
        elif(str(variable29.get())=='pychap2(U 6)'):
            aa29=random.choice(L15)
            L15.remove(aa29)
        elif(str(variable29.get())=='pychap2(A 2)'):
            aa29=random.choice(L16)
            L16.remove(aa29)
        elif(str(variable29.get())=='pychap2(A 4)'):
            aa29=random.choice(L17)
            L17.remove(aa29)
        elif(str(variable29.get())=='pychap2(A 6)'):
            aa29=random.choice(L18)
            L18.remove(aa29)
        elif(str(variable29.get())=='pychap3(R 2)'):
            aa29=random.choice(L19)
            L19.remove(aa29)
        elif(str(variable29.get())=='pychap3(R 4)'):
            aa29=random.choice(L20)
            L20.remove(aa29)
        elif(str(variable29.get())=='pychap3(R 6)'):
            aa29=random.choice(L21)
            L21.remove(aa29)
        elif(str(variable29.get())=='pychap3(U 2)'):
            aa29=random.choice(L22)
            L22.remove(aa29)
        elif(str(variable29.get())=='pychap3(U 4)'):
            aa29=random.choice(L23)
            L23.remove(aa29)
        elif(str(variable29.get())=='pychap3(U 6)'):
            aa29=random.choice(L24)
            L24.remove(aa29)
        elif(str(variable29.get())=='pychap3(A 2)'):
            aa29=random.choice(L25)
            L25.remove(aa29)
        elif(str(variable29.get())=='pychap3(A 4)'):
            aa29=random.choice(L26)
            L26.remove(aa29)
        elif(str(variable29.get())=='pychap3(A 6)'):
            aa29=random.choice(L27)
            L27.remove(aa29)
        elif(str(variable29.get())=='pychap4(R 2)'):
            aa29=random.choice(L28)
            L28.remove(aa29)
        elif(str(variable29.get())=='pychap4(R 4)'):
            aa29=random.choice(L29)
            L29.remove(aa29)
        elif(str(variable29.get())=='pychap4(R 6)'):
            aa29=random.choice(L30)
            L30.remove(aa29)
        elif(str(variable29.get())=='pychap4(U 2)'):
            aa29=random.choice(L31)
            L31.remove(aa29)
        elif(str(variable29.get())=='pychap4(U 4)'):
            aa29=random.choice(L32)
            L32.remove(aa29)
        elif(str(variable29.get())=='pychap4(U 6)'):
            aa29=random.choice(L33)
            L33.remove(aa29)
        elif(str(variable29.get())=='pychap4(A 2)'):
            aa29=random.choice(L34)
            L34.remove(aa29)
        elif(str(variable29.get())=='pychap4(A 4)'):
            aa29=random.choice(L35)
            L35.remove(aa29)
        elif(str(variable29.get())=='pychap4(A 6)'):
            aa29=random.choice(L36)
            L36.remove(aa29)
        elif(str(variable29.get())=='pychap5(R 2)'):
            aa29=random.choice(L37)
            L37.remove(aa29)
        elif(str(variable29.get())=='pychap5(R 4)'):
            aa29=random.choice(L38)
            L38.remove(aa29)
        elif(str(variable29.get())=='pychap5(R 6)'):
            aa29=random.choice(L39)
            L39.remove(aa29)
        elif(str(variable29.get())=='pychap5(U 2)'):
            aa29=random.choice(L40)
            L40.remove(aa29)
        elif(str(variable29.get())=='pychap5(U 4)'):
            aa29=random.choice(L41)
            L41.remove(aa29)
        elif(str(variable29.get())=='pychap5(U 6)'):
            aa29=random.choice(L42)
            L42.remove(aa29)
        elif(str(variable29.get())=='pychap5(A 2)'):
            aa29=random.choice(L43)
            L43.remove(aa29)
        elif(str(variable29.get())=='pychap5(A 4)'):
            aa29=random.choice(L44)
            L44.remove(aa29)
        elif(str(variable29.get())=='pychap5(A 6)'):
    ...
    c31=["pychap1(R 2)","pychap1(R 4)","pychap1(R 6)","pychap1(U 2)","pychap1(U 4)","pychap1(U 6)","pychap1(A 2)","pychap1(A 4)","pychap1(A 6)","pychap2(R 2)","pychap2(R 4)","pychap2(R 6)","pychap2(U 2)","pychap2(U 4)","pychap2(U 6)","pychap2(A 2)","pychap2(A 4)","pychap2(A 6)","pychap3(R 2)","pychap3(R 4)","pychap3(R 6)","pychap3(U 2)","pychap3(U 4)","pychap3(U 6)","pychap3(A 2)","pychap3(A 4)","pychap3(A 6)","pychap4(R 2)","pychap4(R 4)","pychap4(R 6)","pychap4(U 2)","pychap4(U 4)","pychap4(U 6)","pychap4(A 2)","pychap4(A 4)","pychap4(A 6)","pychap5(R 2)","pychap5(R 4)","pychap5(R 6)","pychap5(U 2)","pychap5(U 4)","pychap5(U 6)","pychap5(A 2)","pychap5(A 4)","pychap5(A 6)","pychap6(R 2)","pychap6(R 4)","pychap6(R 6)","pychap6(U 2)","pychap6(U 4)","pychap6(U 6)","pychap6(A 2)","pychap6(A 4)","pychap6(A 6)"]
    s=Spinbox(canvas,values=c31,textvariabl=variable30,state='readonly',wrap=True)
    def om31():
        global aa30
        if(str(variable30.get())=='pychap1(R 2)'):
            aa30=random.choice(L1)
            L1.remove(aa30)
        elif(str(variable30.get())=='pychap1(R 4)'):
            aa30=random.choice(L2)
            L2.remove(aa30)
        elif(str(variable30.get())=='pychap1(R 6)'):
            aa30=random.choice(L3)
            L3.remove(aa30)
        elif(str(variable30.get())=='pychap1(U 2)'):
            aa30=random.choice(L4)
            L4.remove(aa30)
        elif(str(variable30.get())=='pychap1(U 4)'):
            aa30=random.choice(L5)
            L5.remove(aa30)
        elif(str(variable30.get())=='pychap1(U 6)'):
            aa30=random.choice(L6)
            L6.remove(aa30)
        elif(str(variable30.get())=='pychap1(A 2)'):
            aa30=random.choice(L7)
            L7.remove(aa30)
        elif(str(variable30.get())=='pychap1(A 4)'):
            aa30=random.choice(L8)
            L8.remove(aa30)
        elif(str(variable30.get())=='pychap1(A 6)'):
            aa30=random.choice(L9)
            L9.remove(aa30)
        elif(str(variable30.get())=='pychap2(R 2)'):
            aa30=random.choice(L10)
            L10.remove(aa30)
        elif(str(variable30.get())=='pychap2(R 4)'):
            aa30=random.choice(L11)
            L11.remove(aa30)
        elif(str(variable30.get())=='pychap2(R 6)'):
            aa30=random.choice(L12)
            L12.remove(aa30)
        elif(str(variable30.get())=='pychap2(U 2)'):
            aa30=random.choice(L13)
            L13.remove(aa30)
        elif(str(variable30.get())=='pychap2(U 4)'):
            aa30=random.choice(L14)
            L14.remove(aa30)
        elif(str(variable30.get())=='pychap2(U 6)'):
            aa30=random.choice(L15)
            L15.remove(aa30)
        elif(str(variable30.get())=='pychap2(A 2)'):
            aa30=random.choice(L16)
            L16.remove(aa30)
        elif(str(variable30.get())=='pychap2(A 4)'):
            aa30=random.choice(L17)
            L17.remove(aa30)
        elif(str(variable30.get())=='pychap2(A 6)'):
            aa30=random.choice(L18)
            L18.remove(aa30)
        elif(str(variable30.get())=='pychap3(R 2)'):
            aa30=random.choice(L19)
            L19.remove(aa30)
        elif(str(variable30.get())=='pychap3(R 4)'):
            aa30=random.choice(L20)
            L20.remove(aa30)
        elif(str(variable30.get())=='pychap3(R 6)'):
            aa30=random.choice(L21)
            L21.remove(aa30)
        elif(str(variable30.get())=='pychap3(U 2)'):
            aa30=random.choice(L22)
            L22.remove(aa30)
        elif(str(variable30.get())=='pychap3(U 4)'):
            aa30=random.choice(L23)
            L23.remove(aa30)
        elif(str(variable30.get())=='pychap3(U 6)'):
            aa30=random.choice(L24)
            L24.remove(aa30)
        elif(str(variable30.get())=='pychap3(A 2)'):
            aa30=random.choice(L25)
            L25.remove(aa30)
        elif(str(variable30.get())=='pychap3(A 4)'):
            aa30=random.choice(L26)
            L26.remove(aa30)
        elif(str(variable30.get())=='pychap3(A 6)'):
            aa30=random.choice(L27)
            L27.remove(aa30)
        elif(str(variable30.get())=='pychap4(R 2)'):
            aa30=random.choice(L28)
            L28.remove(aa30)
        elif(str(variable30.get())=='pychap4(R 4)'):
            aa30=random.choice(L29)
            L29.remove(aa30)
        elif(str(variable30.get())=='pychap4(R 6)'):
            aa30=random.choice(L30)
            L30.remove(aa30)
        elif(str(variable30.get())=='pychap4(U 2)'):
            aa30=random.choice(L31)
            L31.remove(aa30)
        elif(str(variable30.get())=='pychap4(U 4)'):
            aa30=random.choice(L32)
            L32.remove(aa30)
        elif(str(variable30.get())=='pychap4(U 6)'):
            aa30=random.choice(L33)
            L33.remove(aa30)
        elif(str(variable30.get())=='pychap4(A 2)'):
            aa30=random.choice(L34)
            L34.remove(aa30)
        elif(str(variable30.get())=='pychap4(A 4)'):
            aa30=random.choice(L35)
            L35.remove(aa30)
        elif(str(variable30.get())=='pychap4(A 6)'):
            aa30=random.choice(L36)
            L36.remove(aa30)
        elif(str(variable30.get())=='pychap5(R 2)'):
            aa30=random.choice(L37)
            L37.remove(aa30)
        elif(str(variable30.get())=='pychap5(R 4)'):
            aa30=random.choice(L38)
            L38.remove(aa30)
        elif(str(variable30.get())=='pychap5(R 6)'):
            aa30=random.choice(L39)
            L39.remove(aa30)
        elif(str(variable30.get())=='pychap5(U 2)'):
            aa30=random.choice(L40)
            L40.remove(aa30)
        elif(str(variable30.get())=='pychap5(U 4)'):
            aa30=random.choice(L41)
            L41.remove(aa30)
        elif(str(variable30.get())=='pychap5(U 6)'):
            aa30=random.choice(L42)
            L42.remove(aa30)
        elif(str(variable30.get())=='pychap5(A 2)'):
            aa30=random.choice(L43)
            L43.remove(aa30)
        elif(str(variable30.get())=='pychap5(A 4)'):
            aa30=random.choice(L44)
            L44.remove(aa30)
        elif(str(variable30.get())=='pychap5(A 6)'):
    ...
    backit1=PhotoImage(file='backdept.png')#back image
    #bitbck2=Button(canvas,image=backit1,height="40",width="150",activebackground="green",padx=2,pady=2,command=om3).place(x=130,y=590)#back button
    b=Button(canvas,text="submit",bg="white",height="4",width="15",command=om3)
