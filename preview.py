...
def preview(acc,bc,aa,aa1,aa2,aa3,aa4,aa5,aa6,aa7,aa8,aa9,aa10,aa11,aa12,aa13,aa14,aa15,aa16,aa17,aa18,aa19,aa20,aa21,aa22,aa23,aa24,aa25,aa26,aa27,aa28,aa29,aa30):
    ...
    canvas=Canvas(root,height=h,width=w,bd=7,relief=RIDGE,scrollregion=(0,0,0,2500),highlightcolor="#016193")
    ...
    def next1():
        from pdf import pdf
        pdf(a,b,aa,aa1,aa2,aa3,aa4,aa5,aa6,aa7,aa8,aa9,aa10,aa11,aa12,aa13,aa14,aa15,aa16,aa17,aa18,aa19,aa20,aa21,aa22,aa23,aa24,aa25,aa26,aa27,aa28,aa29,aa30)
    ...
    a=acc.get()
    canvas.create_text((350,136),anchor=NW, text="IT",font= ("bold",13))
    ...
    canvas.create_text((230,370),anchor=NW, text="5.  Assume suitable additional data,if necessary.",font= ("bold",10))
    ...
    canvas.create_text((230,780),anchor=NW, text="      a.",font= ("bold",13))
    canvas.create_text((300,780),anchor=NW, text=aa7,font= ("bold",13))

    canvas.create_text((230,820),anchor=NW, text="      b.",font= ("bold",13))
    canvas.create_text((300,820),anchor=NW, text=aa8,font= ("bold",13))

    canvas.create_text((230,860),anchor=NW, text="      c.",font= ("bold",13))
    canvas.create_text((300,860),anchor=NW, text=aa9,font= ("bold",13))

    canvas.create_text((230,900),anchor=NW, text="      d.",font= ("bold",13))
    ...
    canvas.create_text((230,980),anchor=NW, text="      a.",font= ("bold",13))
    canvas.create_text((300,980),anchor=NW, text=aa11,font= ("bold",13))

    canvas.create_text((230,1020),anchor=NW, text="      b.",font= ("bold",13))
    canvas.create_text((300,1020),anchor=NW, text=aa12,font= ("bold",13))

    canvas.create_text((230,1060),anchor=NW, text="      c.",font= ("bold",13))
    canvas.create_text((300,1060),anchor=NW, text=aa13,font= ("bold",13))

    canvas.create_text((230,1100),anchor=NW, text="      d.",font= ("bold",13))
    canvas.create_text((300,1100),anchor=NW, text=aa14,font= ("bold",13))

    canvas.create_text((230,1140),anchor=NW, text="      e.",font= ("bold",13))
    canvas.create_text((300,1140),anchor=NW, text=aa15,font= ("bold",13))

    canvas.create_text((230,1180),anchor=NW, text="Q.4              Attempt any SIX                                                                         12Marks",font= ("bold",15))
    canvas.create_text((230,1220),anchor=NW, text="      a.",font= ("bold",13))
    canvas.create_text((300,1220),anchor=NW, text=aa16,font= ("bold",13))

    canvas.create_text((230,1260),anchor=NW, text="      b.",font= ("bold",13))
    canvas.create_text((300,1260),anchor=NW, text=aa17,font= ("bold",13))

    canvas.create_text((230,1300),anchor=NW, text="      c.",font= ("bold",13))
    canvas.create_text((300,1300),anchor=NW, text=aa18,font= ("bold",13))

    canvas.create_text((230,1340),anchor=NW, text="      d.",font= ("bold",13))
    canvas.create_text((300,1340),anchor=NW, text=aa19,font= ("bold",13))

    canvas.create_text((230,1380),anchor=NW, text="      e.",font= ("bold",13))
    canvas.create_text((300,1380),anchor=NW, text=aa20,font= ("bold",13))

    canvas.create_text((230,1420),anchor=NW, text="      f.",font= ("bold",13))
    canvas.create_text((300,1420),anchor=NW, text=aa21,font= ("bold",13))

    canvas.create_text((230,1460),anchor=NW, text="      g.",font= ("bold",13))
    canvas.create_text((300,1460),anchor=NW, text=aa22,font= ("bold",13))

    canvas.create_text((230,1500),anchor=NW, text="Q.5              Attempt any THREE                                                                      12Marks",font= ("bold",15))

    canvas.create_text((230,1540),anchor=NW, text="      a.",font= ("bold",13))
    canvas.create_text((300,1540),anchor=NW, text=aa23,font= ("bold",13))

    canvas.create_text((230,1580),anchor=NW, text="      b.",font= ("bold",13))
    canvas.create_text((300,1580),anchor=NW, text=aa24,font= ("bold",13))

    canvas.create_text((230,1620),anchor=NW, text="      c.",font= ("bold",13))
    canvas.create_text((300,1620),anchor=NW, text=aa25,font= ("bold",13))

    canvas.create_text((230,1660),anchor=NW, text="      d.",font= ("bold",13))
    canvas.create_text((300,1660),anchor=NW, text=aa26,font= ("bold",13))

    canvas.create_text((230,1700),anchor=NW, text="      e.",font= ("bold",13))
    canvas.create_text((300,1700),anchor=NW, text=aa27,font= ("bold",13))

    canvas.create_text((230,1740),anchor=NW, text="Q.6              Attempt any TWO                                                                       12Marks",font= ("bold",15))

    canvas.create_text((230,1780),anchor=NW, text="      a.",font= ("bold",13))
    canvas.create_text((300,1780),anchor=NW, text=aa28,font= ("bold",13))

    canvas.create_text((230,1820),anchor=NW, text="      b.",font= ("bold",13))
    canvas.create_text((300,1820),anchor=NW, text=aa29,font= ("bold",13))

    canvas.create_text((230,1860),anchor=NW, text="      c.",font= ("bold",13))
    canvas.create_text((300,1860),anchor=NW, text=aa30,font= ("bold",13))


    button=Button(canvas,text="Save",bg="lightgreen",command=next1)
    canvas.create_window((300,1900), anchor='nw', window=button)
